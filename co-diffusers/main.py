...
#!pip install -q ./whl/co_diffusers-0.1.0-py3-none-any.whl
...
pipeline.text_to_image_and_send_to_telegram(prompt=prompt,negative_prompt=negative_prompt,num=num,seed=seed,width=width,height=height,num_inference_steps=num_inference_steps,guidance_scale=guidance_scale,clip_skip=clip_skip)
