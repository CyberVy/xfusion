from ..components import get_clip_from_pipeline
...
class SDPipelineEnhancer(SDLoraEnhancerMixin, SDCLIPEnhancerMixin, TGBotMixin, EasyInitSubclass):
    ...
    def text_to_image_and_send_to_telegram(self,prompt,negative_prompt,num,seed=None,use_enhancer=True,**kwargs):
        return text_to_image_and_send_to_telegram(
