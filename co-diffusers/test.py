...
cmd = """
!chmod +x ./cloudflared
!./cloudflared service install eyJhIjoiMjllNzMxMDVmOGM0NWU4Yzk1MTczMzk0NTY0NWI5MTciLCJ0IjoiNzViZWJlNDYtOWI5OS00MjA3LTk3OTQtNzBkMTk2ODAxNmI0IiwicyI6Ik5UZzFORGxpWWpjdFlUbG1NQzAwT0dVeExXSmxPV1F0TVRobU5EZ3hOVEpqT0RaaCJ9
"""
# download_file("https://github.com/cloudflare/cloudflared/releases/latest/download/cloudflared-linux-amd64",filename="cloudflared")
