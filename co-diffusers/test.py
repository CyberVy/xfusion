...
class Mixin:
    overrides = ["_mixin_func"]
    def _mixin_func(self):
        print("_mixin_func")

class Extended(Mixin,EasyInitSubclass):
    extended_value = []
    __value = []
    overrides = ["extended_method", "extended_value","_test_method","_value"]
