...
def load_clip_encoder():
    ...
    _2 = download_file("https://huggingface.co/black-forest-labs/FLUX.1-dev/resolve/main/text_encoder/model.safetensors?download=true",
        directory="./clip_encoder")
    clip_encoder = CLIPTextModel.from_pretrained("./clip_encoder",torch_dtype=torch.bfloat16)
...
def load_t5_encoder():
    ...
    _4 = download_file(
        ...
        directory="./t5_encoder")
    t5_encoder = T5EncoderModel.from_pretrained("./t5_encoder",torch_dtype=torch.bfloat16)
