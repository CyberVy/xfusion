            ...
            with gr.Row():
                ...
                with gr.Column():
                    ...
                    with gr.Accordion("Code",open=False):
                        ...
                        t2i_inputs.append(gr.Code(f"def preprocess({t2i_callback_args_name}):\n  return {t2i_callback_args_name.replace('*','')}",language="python",label="Python"))
            ...
            with gr.Row():
                ...
                with gr.Column():
                    ...
                    with gr.Accordion("Code",open=False):
                        ...
                        i2i_inputs.append(gr.Code(f"def preprocess({i2i_callback_args_name}):\n  return {i2i_callback_args_name.replace('*','')}", language="python", label="Python"))
