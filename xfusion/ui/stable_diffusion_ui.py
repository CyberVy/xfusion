            ...
            with gr.Row():
                ...
                with gr.Column():
                    ...
                    with gr.Accordion("Code",open=False):
                        ...
                        t2i_inputs.append(gr.Code(f"def callback({t2i_callback_args_name}):\n    return {t2i_callback_args_name}",language="python",label="Python"))
            ...
            with gr.Row():
                ...
                with gr.Column():
                    ...
                    with gr.Accordion("Code",open=False):
                        ...
                        i2i_inputs.append(gr.Code(f"def callback({i2i_callback_args_name}):\n    return {i2i_callback_args_name}", language="python", label="Python"))
            ...
            with gr.Row():
                ...
                with gr.Column():
                    ...
                    with gr.Accordion("Code",open=False):
                        ...
                        inpainting_inputs.append(gr.Code(f"def callback({inpainting_callback_args_name}):\n    return {inpainting_callback_args_name}", language="python", label="Python"))
                ...
                with gr.Row():
                    ...
                    with gr.Column():
                        ...
                        with gr.Accordion("Code",open=False):
                            ...
                            controlnet_t2i_inputs.append(gr.Code(f"def callback({controlnet_t2i_args_name}):\n    return {controlnet_t2i_args_name}", language="python", label="Python"))
                ...
                with gr.Row():
                    ...
                    with gr.Column():
                        ...
                        with gr.Accordion("Code",open=False):
                            ...
                            controlnet_i2i_inputs.append(gr.Code(f"def callback({controlnet_i2i_args_name}):\n    return {controlnet_i2i_args_name}", language="python", label="Python"))
                ...
                with gr.Row():
                    ...
                    with gr.Column():
                        ...
                        with gr.Accordion("Code",open=False):
                            ...
                            controlnet_inpainting_inputs.append(gr.Code(f"def callback({controlnet_inpainting_args_name}):\n    return {controlnet_inpainting_args_name}", language="python", label="Python"))
